...
import { dashboardsAtom } from '../../admin/component/dashboard/dashboard.atom.jsx';
import LoadingComponent from '../../admin/component/loading/loading.component.js';
import { useHttpClientSimple } from '../../admin/library/simple.http-client.js';
import { IBaseWidgetProps } from '../../admin/types/base-widget.type.js';
