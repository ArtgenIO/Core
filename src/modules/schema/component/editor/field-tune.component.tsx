...
export default function SchemaEditorFieldTunerComponent({
  ...
  const [refLinked, setRefLinked] = useState(isNewSchema);
  const [clmLinked, setClmLinked] = useState(isNewSchema);
        ...
        >
          ...
          >
            <Input
              ...
              disabled={
                !isNewSchema &&
                !!immutableSchema.fields.find(
                  f => f.reference == schema.fields[idx].reference,
                )
              }
              suffix={
                isNewSchema && (
          ...
          <Form.Item
            ...
            name="columnName"
            className="mb-2"
            rules={[{ required: true, message: 'Please type a column name!' }]}
          >
            <Input
          ...
          <Form.Item label="Default Value" name="defaultValue" className="mb-2">
