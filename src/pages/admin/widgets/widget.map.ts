...
import { IBaseWidgetProps } from '../../../api/types/base-widget.type';
...
WidgetMap.set('telemetry.uptime', {
  element: lazy(() => import('../components/telemetry/uptime.widget')),
  defaults: {
    dimensions: {
      w: 3,
      h: 3,
...
WidgetMap.set('telemetry.serie', {
  element: lazy(() => import('../components/telemetry/serie.widget')),
  defaults: {
    dimensions: {
      w: 7,
      h: 4,
...
WidgetMap.set('note', {
  element: lazy(() => import('./note.widget')),
  defaults: {
    dimensions: {
      w: 3,
      h: 2,
